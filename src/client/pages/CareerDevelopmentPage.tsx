...
import { SkillGap, Course, CareerGoal, Milestone, LearningPath, LearningStep, SalaryData, Achievement, NetworkingContact, IndustryTrend, CareerAssessment, AssessmentQuestion, NetworkingEvent, NetworkingOpportunity, } from '@/shared/types/careerTypes';
