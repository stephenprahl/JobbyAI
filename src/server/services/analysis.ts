import { AnalysisResult, JobAnalysisRequest, JobListing } from '../schemas/analysis';
 ...
 */
async function llmRequest(messages: Array<{ role: string, content: string }>, model: string = 'gemini-1.5-flash') {
  try {
